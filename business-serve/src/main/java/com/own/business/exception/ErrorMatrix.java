...
public class ErrorMatrix {
     ...
     * 该卡有人使用无法禁用
     */
    public  final static String CARD_USE_NO="有人使用无法禁用";
    /**
     * 该卡有人使用的code
     */
    public  final static String CODE_USE_NO="602";
     ...
     * 提示信息
     */
    public static final String PERSONAL_EFFECTS_INFO = "人员存储物品未取出！";

    public final static String RECORD_INFO = "人员审讯未完成！";

    public static final String PERSONAL_WAIT_INFO = "人员处于候问状态！";
